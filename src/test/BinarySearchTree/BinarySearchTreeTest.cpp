...
TEST(SpecialFunctions, InitializerListConstructor) {
  ...
  tree::BinarySearchTree<int> btree2({4, 1, 5, 6, 3, 7, 2, 2});
  ...
  tree::BinarySearchTree<int> btree3({});
  EXPECT_EQ(btree3.size(), 0);
  EXPECT_TRUE(btree3.empty());
...
TEST(SpecialFunctions, RangeConstructor) {
  ...
  tree::BinarySearchTree<int> btree1(array, array);
  EXPECT_TRUE(btree1.empty());
  EXPECT_EQ(btree1.begin(), btree1.end());

  tree::BinarySearchTree<int> btree2(array, array + 4);
  ...
  tree::BinarySearchTree<int> btree3(array, array + 8);
...
TEST(SpecialFunctions, CopyConstructor) {
  tree::BinarySearchTree<int> btree1({1, 2, 3, 4});
  tree::BinarySearchTree<int> btree1_copy(btree1);
  ...
  tree::BinarySearchTree<int> btree2{4, 1, 5, 6, 3, 7, 2, 2};
  tree::BinarySearchTree<int> btree2_copy(btree2);
  ...
  tree::BinarySearchTree<int> btree3({});
  tree::BinarySearchTree<int> btree3_copy(btree3);
...
TEST(SpecialFunctions, MoveConstructor) {
  tree::BinarySearchTree<int> btree1{1, 2, 3, 4};
  tree::BinarySearchTree<int> btree1_copy(std::move(btree1));
  EXPECT_EQ(btree1.size(), 0);
  ...
  tree::BinarySearchTree<int> btree2{4, 1, 5, 6, 3, 7, 2, 2};
  tree::BinarySearchTree<int> btree2_copy(std::move(btree2));
  EXPECT_EQ(btree2.size(), 0);
  ...
  tree::BinarySearchTree<int> btree3;
  tree::BinarySearchTree<int> btree3_copy(std::move(btree3));
  EXPECT_EQ(btree3.size(), 0);
...
TEST(Iterators, IteratorOperations) {
  ...
  tree::BinarySearchTree<int> btree2({std::numeric_limits<int>::max(), 0});
  ...
  tree::BinarySearchTree<int> btree3({3, 1, 8, 6, 4});
  ...
  tree::BinarySearchTree<std::vector<int>> btree4;
...
TEST(Capacity, Empty) {
  tree::BinarySearchTree<int> btree1({1, 2, 3});
  EXPECT_FALSE(btree1.empty());

  tree::BinarySearchTree<int> btree2({5, 1, 9, 10, 2});
  EXPECT_FALSE(btree2.empty());

  tree::BinarySearchTree<int> btree3({1});
  EXPECT_FALSE(btree3.empty());

  tree::BinarySearchTree<int> btree4({});
...
TEST(Modifiers, Insert) {
  tree::BinarySearchTree<int> btree1({4, 1, 3});
  btree1.insert(0);
  ...
  tree::BinarySearchTree<int> btree2;
  btree2.insert(-9);
...
TEST(Modifiers, Erase) {
  ...
  tree::BinarySearchTree<int> btree2({5, 1, 9, 10, 2, 2});
